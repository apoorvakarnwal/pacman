...
blinky_img = pygame.transform.scale(pygame.image.load(f'assets/ghost_images/red.png'), (41, 41))
pinky_img = pygame.transform.scale(pygame.image.load(f'assets/ghost_images/pink.png'), (41, 41))
inky_img = pygame.transform.scale(pygame.image.load(f'assets/ghost_images/blue.png'), (41, 41))
clyde_img = pygame.transform.scale(pygame.image.load(f'assets/ghost_images/orange.png'), (41, 41))
spooked_img = pygame.transform.scale(pygame.image.load(f'assets/ghost_images/powerup.png'), (41, 41))
dead_img = pygame.transform.scale(pygame.image.load(f'assets/ghost_images/dead.png'), (41, 41))
...
class Ghost:
    ...
    def check_collisions(self):
        ...
        if 0 < self.center_x // 30 < 29:
            ...
            self.turns[0] = True
            self.turns[1] = True
        if 350 < self.x_pos < 550 and 340 < self.y_pos < 440:
            self.in_box = True
        else:
            self.in_box = False
...
def draw_misc():
    ...
    screen.blit(score_text, (10, 837))
    if powerup:
        pygame.draw.circle(screen, 'blue', (140, 847), 15)
    for i in range(lives):
        screen.blit(pygame.transform.scale(player_images[0], (30, 30)), (650 + i * 40, 825))
    if game_over:
...
def draw_board():
    pygame.draw.circle(screen, 'red',(450, 390) ,4)
    num1 = ((height - 50) // 32)
    num2 = (width // 30)
...
def get_targets(blink_x, blink_y, ink_x, ink_y, pink_x, pink_y, clyd_x, clyd_y):
    ...
    if player_y < 450:
        ...
        runaway_y = 0
    return_target = (380, 390)
    if powerup:
        if not blinky.dead and not eaten_ghost[0]:
            blink_target = (runaway_x, runaway_y)
        elif not blinky.dead and eaten_ghost[0]:
            if 340 < blink_x < 560 and 320 < blink_y < 450:
                blink_target = (450, 100)
            else:
        ...
        if not inky.dead and not eaten_ghost[1]:
            ...
            if 340 < ink_x < 560 and 340 < ink_y < 450:
                ink_target = (450, 100)
            else:
        ...
        if not pinky.dead:
            ...
            if 340 < pink_x < 560 and 340 < pink_y <450:
                pink_target = (450, 100)
            else:
        ...
        if not clyde.dead and not eaten_ghost[3]:
            ...
            if 340 < clyd_x < 560 and 340 < clyd_y < 450:
                clyd_target = (450, 100)
            else:
        ...
        if not blinky.dead:
            ...
            blink_target = return_target
        if not inky.dead:
            if 340 < ink_x < 560 and 320 < ink_y < 450:
                ink_target = (450, 100)
            else:
                ink_target = (player_x, player_y)
        else:
            ink_target = return_target
        if not pinky.dead:
            if 320 < pink_x < 560 and 310 < pink_y < 450:
                pink_target = (450, 100)
            else:
                pink_target = (player_x, player_y)
        else:
            pink_target = return_target
        if not clyde.dead:
            if 340 < clyd_x < 560 and 320 < clyd_y < 450:
                clyd_target = (450, 100)
            else:
                clyd_target = (player_x, player_y)
        else:
